  ...
  return (
    <section className="section-darker" id="reformas">
      ...
      <div className="ref-photo-hero">
        ...
        <img
          src="/images/banco/gabinete-motosierra.jpg"
      ...
      <div className="reforms-container">
        ...
        <FadeIn>
          <div className="ref-photo-break">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/banco/pacto-mayo-tucuman.jpg" alt="Pacto de Mayo — Gobernadores firman pacto de reformas estructurales" loading="eager" />
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="ref-photo-break">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/banco/apertura-sesiones-2024.jpg" alt="Milei en el Congreso — Apertura de sesiones 2024" loading="eager" />
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="ref-photo-break">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/banco/presupuesto-congreso.jpg" alt="Milei presenta el presupuesto en el Congreso" loading="eager" />
          </div>
        </FadeIn>
