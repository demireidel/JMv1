...
export const reformBlocks: ReformBlock[] = [
  {
    ...
    subtitle: "Los tres exámenes aprobados: fiscal, monetario y cambiario",
    range: [0, 3],
  },
  {
    title: "BLOQUE II — DESREGULACIÓN Y REFORMA DEL ESTADO",
    subtitle: "DNU 70/23, Ley Bases, y 14.500 desregulaciones: de la economía más regulada a la más libre",
    range: [3, 7],
  },
  {
    title: "BLOQUE III — REFORMAS LEGISLATIVAS",
    subtitle: "Con el Congreso más reformista de la historia: laboral, comercial, fiscal y penal",
    range: [7, 10],
  },
  {
    title: "BLOQUE IV — SEGURIDAD Y JUSTICIA",
    subtitle: "Sin orden y sin justicia no hay futuro posible. Nadie puede edificar su futuro si no se respeta la ley.",
    range: [10, 12],
  },
];
...
export const reformas: Reforma[] = [
  {
    ...
    desc: "Argentina había logrado solo 8 superávits fiscales en 100 años. Cuando asumí, el déficit consolidado era de 15 puntos del PIB y la maquinita de imprimir billetes funcionaba las 24 horas para financiar la fiesta de la casta. Lo primero que hice fue dar vuelta la ecuación: recorté el 30% del gasto público real en un solo año, eliminé las transferencias discrecionales a provincias, reduje subsidios y terminé con la obra pública como herramienta de corrupción. En 2024 logramos el primer superávit financiero en 16 años. En 2025 lo repetimos. Y aprobamos el primer presupuesto sin déficit ni default en más de 100 años. Hoy somos uno de los cinco países del mundo que solo gastan lo que recaudan y ni un peso más.",
    antes:
      "Déficit consolidado de 15 puntos del PIB. Solo 8 superávits fiscales en un siglo de historia. Emisión monetaria descontrolada para financiar gasto corriente. Transferencias discrecionales a gobernadores amigos. Obra pública como herramienta de saqueo sistemático. La cuenta se la pasaban a las generaciones futuras a través de deuda e inflación.",
    ahora:
      "Superávit primario de 1,8% del PIB en 2024 y 1,4% en 2025. Dos años consecutivos de superávit financiero — el primero desde 2008. Cero emisión para financiar déficit. Presupuesto 2026 equilibrado. Baja impositiva de 2,5 puntos del PIB devueltos a los argentinos de bien. A diferencia de otros gobiernos que lograron superávit subiendo impuestos, nosotros lo hicimos bajándolos.",
    impactStats: [
  ...
  },
  {
    ...
    ahora:
      "~30% anual en 2025 — la más baja en ocho años. Inflación mensual estabilizada entre 1,5% y 2,2%. Tendencia descendente sostenida durante 24 meses consecutivos. Precios mayoristas casi en un dígito. El peso se apreció sin precedentes. Proyección 2026: por debajo del 20%. Meta de un dígito para 2027.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "El cepo cambiario fue la herramienta más perversa del kirchnerismo: un control de capitales que duró más de 6 años. En abril de 2025, liberé completamente el mercado cambiario para las personas físicas. La brecha desapareció.",
    antes:
      "Restricciones cambiarias ininterrumpidas desde 2019. Brecha cambiaria superior al 100%. Múltiples tipos de cambio. Riesgo país en 2.400 puntos.",
    ahora:
      "Mercado cambiario libre con banda de flotación administrada. Brecha eliminada. Acuerdo con el FMI por USD 20.000M a 48 meses.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "A diez días de asumir firmé el DNU 70/23: 366 artículos. Derogué la Ley de Alquileres, la Ley de Abastecimiento, la Ley de Góndolas. En un solo decreto, desregulamos más que cualquier gobierno en toda la historia argentina.",
    antes:
      "Más de 300 leyes y regulaciones que impedían el comercio, el trabajo y la producción. Ley de Alquileres que destruyó la oferta. Mercados cautivos.",
    ahora:
      "366 artículos de desregulación en un solo decreto. Mercados de alquileres, aviación, salud y telecomunicaciones completamente liberados. Starlink conectando zonas rurales.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "Con solo 7 senadores propios de 72, logramos aprobar la Ley Bases y el RIGI (Régimen de Incentivo para Grandes Inversiones), que garantiza estabilidad fiscal, aduanera y cambiaria por 30 años para inversiones de más de USD 200 millones.",
    antes:
      "Sin marco legal para grandes inversiones. Inestabilidad regulatoria crónica. Sin privatizaciones posibles. Inversores huyendo.",
    ahora:
      "RIGI aprobado: estabilidad por 30 años. Más de USD 25.000M en proyectos aprobados. Privatizaciones habilitadas.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "El Estado argentino era un monstruo que se devoraba a sí mismo. 18 ministerios, 84 secretarías y más de 340.000 empleados públicos nacionales. Reduje los ministerios a 8, las secretarías a 51, eliminé 63.234 cargos innecesarios.",
    antes: "18 ministerios y 84 secretarías. ~340.000 empleados públicos nacionales, muchos sin función alguna. 32 empresas públicas con déficit conjunto masivo. TELAM, INADI y decenas de organismos inútiles.",
    ahora: "8 ministerios, 51 secretarías. 277.000 empleados — 63.234 cargos eliminados. TELAM, INADI y decenas de organismos disueltos. Empresas públicas con superávit de $109.200M.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "Los campeones de los derechos de los trabajadores dejaron sin ningún tipo de derechos a la mitad de los trabajadores. Una ley de más de 50 años había dejado a la mitad de los trabajadores argentinos en la informalidad.",
    antes: "Ley laboral de más de 50 años sin actualizar. La mitad de los trabajadores argentinos en la informalidad total. Indemnizaciones calculadas sobre todos los conceptos salariales.",
    ahora: "Fondo de Asistencia Laboral (FAL) como alternativa moderna a las indemnizaciones. Período de prueba de 6 meses (hasta 1 año para PyMEs). Servicios esenciales con 75% de funcionamiento.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "Argentina era una de las economías más cerradas de la región. El sistema SIRA de permisos previos obligatorios era un mecanismo de extorsión burocrática. El impuesto PAIS encarecía toda importación. 138 medidas de apertura cambiaron todo.",
    antes: "Sistema SIRA de permisos previos obligatorios para importar — mecanismo de extorsión burocrática. Impuesto PAIS sobre importaciones y operaciones en dólares. Aranceles del 35% en múltiples productos.",
    ahora: "SIRA eliminado. Impuesto PAIS eliminado. 138 medidas de apertura implementadas. Acuerdo Mercosur-UE ratificado por el Senado. TLC con EE.UU. y EFTA firmados.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "En materia tributaria éramos todos culpables. La política había vulnerado una cuestión constitucional básica: la presunción de inocencia. El Estado podía perseguir, embargar y destruir a cualquier contribuyente sin necesidad de probar nada.",
    antes: "Presunción de culpabilidad tributaria de facto. El Estado podía embargar sin necesidad de probar la existencia de una deuda. AFIP con poderes discrecionales para perseguir contribuyentes.",
    ahora: "Presunción de inocencia restaurada en materia tributaria. El Estado debe probar antes de perseguir, no al revés. Protección contra embargos arbitrarios.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "Cuando asumí, las calles eran tierra de nadie. Más de 9.000 piquetes al año. Rosario era la capital narco del país con 261 homicidios. El protocolo antipiquetes de Patricia Bullrich terminó de raíz con los cortes.",
    antes: "9.000+ piquetes al año con impunidad total. Rosario: 261 homicidios, capital narco del país. Puerta giratoria judicial que devolvía delincuentes a la calle en horas.",
    ahora: "Cero piquetes. Homicidios –17% a nivel nacional y –65% en Rosario (de 261 a 91). Robos –20% — mínimo histórico. Ley Antimafia aprobada 38 a 0. Más de 600 detenidos narco.",
    impactStats: [
  ...
  },
  {
    ...
    desc: "El Régimen Penal Juvenil vigente tenía 45 años de antigüedad — una norma obsoleta de la dictadura militar de 1980. Menores de edad eran utilizados por organizaciones narco como soldados descartables, porque sabían que no iban a tener consecuencias penales.",
    antes: "Régimen penal juvenil de 1980 — dictadura militar. 45 años sin una sola reforma. Menores de 16 años absolutamente inimputables sin importar el delito cometido. Organizaciones narco usando menores como soldados.",
    ahora: "Imputabilidad desde los 14 años para delitos graves. Nuevo régimen penal juvenil completo con medidas socioeducativas graduales. Proporcionalidad de penas adaptada a la edad.",
    impactStats: [
